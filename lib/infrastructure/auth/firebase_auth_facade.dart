...
class FirebaseAuthFacade implements IAuthFacade {
  ...
  Future<Either<AuthFailure, Unit>> registerWithEmailAndPassword({
    ...
    // TODO: non null safety here
    String emailAddressStr = 'temp@nonnull.com';
    String passwordStr = '123456nonnull';

    if (emailAddress != null && password != null) {
      emailAddressStr = emailAddress.getOrCrash();
      passwordStr = password.getOrCrash();
    }
